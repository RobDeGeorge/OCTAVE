...
SCRCPY_DEBUG=false
SCRCPY_VERSION_NAME=3.3.4-octave
...
SERVER_BINARY=octave-phone-server
...
mkdir -p "$CLASSES_DIR"
mkdir -p "$GEN_DIR/org/octave/phoneserver"

<< EOF cat > "$GEN_DIR/org/octave/phoneserver/BuildConfig.java"
...
SRC=( \
    org/octave/phoneserver/*.java \
    org/octave/phoneserver/audio/*.java \
    org/octave/phoneserver/control/*.java \
    org/octave/phoneserver/device/*.java \
    org/octave/phoneserver/opengl/*.java \
    org/octave/phoneserver/util/*.java \
    org/octave/phoneserver/video/*.java \
    org/octave/phoneserver/wrappers/*.java \
)
